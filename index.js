...
//
const BotName = 'MIMIM-BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/pingin_waras/'; // Nama Instagramlu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by MiMiM`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by MiMiM`)
})
